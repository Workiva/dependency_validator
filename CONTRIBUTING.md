# Contributing to dependency_validator
...
[open an issue](https://github.com/Workiva/dependency_validator/issues/new) and fill out
...
Please contact us on Slack or [create a JIRA ticket](https://jira.atl.workiva.net/secure/CreateIssue!default.jspa?pid=CPLAT&component=dependency_validator)
and fill out the description with as much detail as necessary.

## Contributing Changes
If you're contributing a change to dependency_validator, please follow this process: (and
thank you!)
